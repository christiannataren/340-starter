...
async function getAccountPrivilege(id_account) {
    try {
...
module.exports = { updateUserPassword, updateUser, getAccountById, getAccountPrivilege, registerAccount, checkExistingEmail, getAccountByEmail };