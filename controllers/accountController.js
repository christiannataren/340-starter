...
baseController.buildRegister = async function (req, res, next) {
    let nav = await utilities.getNav()
...
* *************************************** */
baseController.registerAccount = async function (req, res) {
    let nav = await utilities.getNav()
 ...
 * ************************************ */
baseController.accountLogin = async function (req, res) {
    let nav = await utilities.getNav()
