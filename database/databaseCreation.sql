...
(
    ...
    version_image text COLLATE pg_catalog."default" NOT NULL,
    version_name character varying(50) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT version_pkey PRIMARY KEY (version_id),
    CONSTRAINT version_inventory_id_fkey FOREIGN KEY (inv_id)
